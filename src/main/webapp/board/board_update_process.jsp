...
<script type="text/javascript">
	...
	%> 
	alert("글을 수정하였습니다.");
	location.href="http://192.168.10.230/jsp_prj/board/board_list.jsp?currentPage=${ param.currentPage }";//param.currentPage는 hidden에 들어있음
	<%
	}else{
		%>
	...
	<%
		...
		se.printStackTrace();
		%>
		location.href="http://192.168.10.230/jsp_prj/error/err_500.html";
		<%
	}//end catch
